...
class instance extends base_instance {
    ...
    protected function extend_form_definition(\MoodleQuickForm $mform): void {
        ...
        $mform->addElement('text', 'catalogid', 'Yandex Cloud Folder ID');
        $mform->addHelpButton('catalogid', 'catalogid', 'aitool_yandexgpt');
        $mform->addRule('catalogid', null, 'required');
    ...
    protected function get_extended_formdata(): stdClass {
        ...
        $data->catalogid = $this->get_catalog_id();
        return $data;
    }
    ...
    protected function extend_validation(array $data, array $files): array {
        ...
        if (empty($data['catalogid'])) {
            $errors['catalogid'] = get_string('formvalidation_nocatalogid', 'aitool_yandexgpt');
        }
        return $errors;
    }
    ...
    protected function extend_store_formdata(stdClass $data): void {
        ...
        $this->set_customfield2($data->catalogid);
    }
    ...
    /**
     * Return the Yandex Cloud Folder ID.
     * @return string
     */
    public function get_catalog_id(): string {
        return $this->get_customfield2();
    }
}